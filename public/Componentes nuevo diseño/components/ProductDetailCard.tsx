...
export function ProductDetailCard({
  ...
  return (
    <div 
      className={`bg-[#F5F5F2] rounded-xl border border-[#E6DDC5] shadow-[0_1px_3px_rgba(0,0,0,0.04)] transition-all ${
        isExpanded ? 'shadow-[0_3px_8px_rgba(0,0,0,0.06)]' : ''
      }`}
    >
        ...
        <div className="mb-2.5">
          ...
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
              size="icon"
              className="h-11 w-11 rounded-lg border-2 border-[#DAD7CD] bg-white hover:bg-[#C1643B] hover:text-white hover:border-[#C1643B] active:scale-95 transition-all disabled:opacity-30"
            ...
            <Input
              ...
              className={`h-11 flex-1 text-center text-lg border-2 focus:ring-[#C1643B]/20 focus:border-[#C1643B] rounded-lg tabular-nums bg-white transition-all ${
                localQuantity === 0 
                  ? 'border-[#DAD7CD] text-[#888880]' 
                  : 'border-[#C1643B] text-[#1F1F1F]'
              }`}
            />
            ...
            <Button
              variant="outline"
              size="icon"
              className="h-11 w-11 rounded-lg border-2 border-[#DAD7CD] bg-white hover:bg-[#C1643B] hover:text-white hover:border-[#C1643B] active:scale-95 transition-all"
              onClick={() => handleQuantityChange(localQuantity + 1)}
            >
      ...
      {isExpanded && (
        <div 
          className="border-t border-[#E6DDC5] px-3.5 pb-3.5 pt-3 space-y-2.5"
        ...
        >
          ...
          <div className="pt-2 border-t border-[#DAD7CD]">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="bg-[#E6DDC5]/30 rounded-lg p-2">
            ...
            <div className="flex items-center gap-2 mt-3 flex-wrap">
              ...
              {previousOrder > 0 && (
                <span className="text-xs text-[#2C4653]/70 bg-[#E6DDC5]/60 rounded-full px-2 py-1">
